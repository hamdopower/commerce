          ...
          <div className="p-8 lg:p-12 space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.colors.map((color: any, index: any) => (
                    <button
                      ...
                      className={`px-4 py-2 border-2 font-medium transition-all cursor-pointer whitespace-nowrap ${selectedColor === color
            ...
            <div className="space-y-3 pt-6">
              <button
                ...
                className={`w-full bg-black text-white py-4 font-bold text-lg hover:bg-gray-800 transition-all duration-300 cursor-pointer whitespace-nowrap relative overflow-hidden ${isAddingToCart ? 'animate-pulse' : ''
                  }`}
              >
                {isAddingToCart && (
              ...
              <button
                ...
                className={`w-full border-2 border-black text-black py-4 font-bold text-lg hover:bg-black hover:text-white transition-all duration-300 cursor-pointer whitespace-nowrap flex items-center justify-center space-x-2 ${isAddingToWishlist ? 'animate-pulse' : ''
                  }`}
              >
                <i className={`w-5 h-5 flex items-center justify-center ${cartStore.isInWishlist(product.id.toString()) ? 'ri-heart-fill text-red-600' : 'ri-heart-line'
                  }`}></i>
                <span>
